            ...
            <PageContainer>
                <SafeAreaProvider>
                    <SafeAreaView style={{ backgroundColor: "#5FBA62", height: "50%" }}>
                        ...
                        <Text style={{ color: "white", textAlign: "center", fontSize: 16, fontFamily: 'Avenir-Light', fontWeight: "bold", marginTop: 15 }}>{this.state.name}</Text>
                        <Text style={{ color: "white", textAlign: "center", fontSize: 16, fontFamily: 'Avenir-Light', marginTop: 5 }}>Level {this.state.points.alltime % 100}</Text>
